...
class TableManger:
    ...
    def insert(self, update_dict: dict[str, str]):
        # TODO: update the signature and handle errors more gracefully
        ...
        column_names, column_len = (
            ", ".join([val for val in update_dict.keys()]),
